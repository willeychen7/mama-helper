...
| Suite | Result |
|---|---|
| **Real bills, hand-labeled ground truth** | 14 letters × 5 fields — category 13/14 93%   amount 14/14 100%   payment 13/14 93%   due date 14/14 100%   statement date 13/14 93% |
